...
namespace UdeoSolid2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var p in bf.Filter(products, pfand))
            ...
            foreach (var p in bf.Filter(products, pfandCustom))
